                                    ...
                                    <td>
                                        ...
                                        @can('mantenimiento.clientes.estado')
                                            <button class="btn btn-icon btn-secondary btn-sm" title="Estado"
                                                wire:click="status({{ $cliente->id }})"><i
                                        ...
                                        @can('mantenimiento.clientes.eliminar')
                                            <button x-data="eliminar" class="btn btn-icon btn-danger btn-sm"
                                                title="Eliminar" x-on:click="confirmar({{ $cliente->id }})"><i
        ...
        <div class="table-responsive">
            @if ($vcliente)
                <table class="table table-sm table-hover text-small">
                    <tbody>
                        <tr>
                            <th colspan="2"><small>Nombre/Razón Social</small>
                                <h5 class="text-info">{{ $vcliente->razon_social }}</h5>
                            </th>
                        </tr>
                        <tr>
                            <th>T. Documento</th>
                        ...
                        <tr>
                            <th>F. Nacimiento</th>
                            <td>{{ date('d/m/Y', strtotime($vcliente->fnacimiento)) }}</td>
                        </tr>
                        <tr>
                            <th>Dirección</th>
