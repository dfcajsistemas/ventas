<div>
    <h4><span class="text-muted fw-light">Abastecimiento /</span> Productos <span class="text-warning">(Sucursal:
        {{$sucursal_nombre}})</span></h4>
    <div class="card">
            ...
            <table class="table table-sm table-hover text-small">
                ...
                <tbody>
                    ...
                    <tr wire:key="{{ $producto->id }}">
                        ...
                        @endphp
                        <td>@if($stock){{ $stock->stock_minimo}}@endif</td>
                        <td>@if($stock){{$stock->stock}}@endif</td>
                        @canany(['abastecimiento.productos.reposiciones', 'abastecimiento.productos.stock'])
                        <td>
